...
var file_stream_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x22, 0x23, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	...
	,
}
...
var file_stream_proto_goTypes = []interface{}{
	(*StreamReqData)(nil), // 0: stream.StreamReqData
	(*StreamResData)(nil), // 1: stream.StreamResData
}
var file_stream_proto_depIdxs = []int32{
	0, // 0: stream.Greeter.GetStream:input_type -> stream.StreamReqData
	0, // 1: stream.Greeter.PutStream:input_type -> stream.StreamReqData
	0, // 2: stream.Greeter.AllStream:input_type -> stream.StreamReqData
	1, // 3: stream.Greeter.GetStream:output_type -> stream.StreamResData
	1, // 4: stream.Greeter.PutStream:output_type -> stream.StreamResData
	1, // 5: stream.Greeter.AllStream:output_type -> stream.StreamResData
...
func (c *greeterClient) GetStream(ctx context.Context, in *StreamReqData, opts ...grpc.CallOption) (Greeter_GetStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/stream.Greeter/GetStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) PutStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_PutStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[1], "/stream.Greeter/PutStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) AllStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_AllStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[2], "/stream.Greeter/AllStream", opts...)
	if err != nil {
		return nil, err
	}
